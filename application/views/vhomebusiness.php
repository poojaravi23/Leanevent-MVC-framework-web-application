	...
	<body class="wrapper" >
		...
		<h2 style="font-weight:normal;margin-bottom: 50px;font-size: 150%;">Lista de Eventos</h2>
				...
				<table class="eventable" style="width:1200px;text-align: center;">
 				...
 				<?php echo form_open('Homebusiness/businessinsert');
			...
			<?php if(isset($popid)){
				echo "<script>location.href = '".base_url()."Homebusiness/".$popid."';</script>"; 
			}
			?>
			...
			<div id="confirmPop" class="overlay" style="text-align: left;">
					<div class="popup" style="height:170px; width: 30%; left: 100px;margin-top:5px;">
						...
						<hr color="#F0F0F0">
						 <p style="text-align: center;">Gracias por ser parte en nuestros evento</p>
						<hr  color="#F0F0F0">
						<a href="<?php echo base_url(); ?>Homebusiness"> <input type="submit"value="Close" style="margin-left: 370px;background-color:#D4D4D4;color: black; "></a>
