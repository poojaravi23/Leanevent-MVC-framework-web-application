...
<html>
	...
	<body class="wrapper">
		...
		<?php echo form_open('Homebusiness/validbusprofile');
		foreach ($businessprofile->result() as $row)
        		{  
		?>
		...
		<div  class="classform">
			<div class="row">
					...
					<div style="width:33%;" class="column"><i class='fas fa-book'></i><?php echo $row->Firstname." ".$row->Lastname;?><br><br>
						<i class='fas fa-book'> </i><?php echo $row->Foundation_name;?><br><br>
					...
					<div style="width:33%;"class="column">
						<?php  echo '<img src="data:image/jpeg;base64,'.base64_encode($row->Logo).'" style="width:100px; height:100px; "class="indimage"/>'?>
					</div>
					...
					<div style="width: 850px;" class="contactform">
						<div class="row">
							...
							<div  style="width:60%;"class="column">
								...
								<label style=" font-weight:bold;" for="fname">Nombres y Appelido</label>
							    <br>
							    <?php echo form_input(array(
						        	...
						        	'placeholder'=>'Tu Nombre y Appelido',
						        	'readonly'=>'readonly'));?>
						
							    <br>
							    <div><label style=" font-weight:bold;" for="lname">Nombre de la Fundacion</label>
							    <br>
							    <?php echo form_input(array(
						        	'type' =>'text',
						        	'id'=>'lname',
							...
							<div style="width:40%;" class="column">
								<?php  echo '<img src="data:image/jpeg;base64,'.base64_encode($row->Logo).'" style="width:100px; height:100px; margin-left:75px; "class="indimage"/>'?>
								<br>
																
						<input style="width:130px;padding:10px;margin-left:60px;"type="submit" value="Seleccionar Logo">
