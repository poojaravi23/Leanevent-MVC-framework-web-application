...
<html>
	...
	<body class="wrapper">
		...
		<?php echo form_open('Homeagent/validageprofile');
		foreach ($agentprofile->result() as $row)
        		{  
		?>
		...
		<div  class="classform">
			<div class="row">
					...
					<div style="width:33%;" class="column"><i class='fas fa-book'></i><?php echo $row->Firstname." ".$row->Lastname;?><br><br>
						<i class='fas fa-book'> </i><?php echo $row->Registration_num;?><br><br>
					...
					<div style="width: 850px;" class="contactform">
						<div class="row">
							...
							<div  style="width:60%;"class="column">
							    ...
							    <br>
							    <div><label style=" font-weight:bold;" for="lname">Numero de Registro del Inscrito</label>
							    <br>
							    <?php echo form_input(array(
						        	'type' =>'text',
						        	'id'=>'lname',
